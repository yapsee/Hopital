                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="date" id="datetimepicker" class="form-control"
                                        placeholder="Date de rendez-vous *" value="" readonly />
                                </div>
                                <div class="form-group">
                                    <div class="maxl">
                                        <label class="radio inline">
                                            <input type="radio" name="genre" value="homme" value="<?php if ($patientInf->prenom_patient = "homme") : echo 'checked';
                                                                                                            endif ?>">
                                            <span> Homme </span>
                                        </label>
                                        <label class="radio inline">
                                            <input type="radio" name="genre" value="femme" <?php if ($patientInf->prenom_patient = "femme") : echo 'checked';
                                                                                                    endif ?>>
                                            <span>Femme </span>
                                        </label>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="tel" minlength="9" maxlength="9" class="form-control"
                                        placeholder="Telephone *" value="<?= $patientInf->tel_patient ?>" />
                                </div>
                                <div class="form-group">
